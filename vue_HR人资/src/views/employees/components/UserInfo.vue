      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <image-upload ref="myAvatar" :default-img="userInfo.staffPhoto" :limit="1" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <image-upload ref="myPhoto" :default-img="formData.staffPhoto" :limit="1" />
        </el-form-item>
    ...
    async savePersonal () {
      try {
        if (!this.$refs.myPhoto.isAllSuccess) {
          this.$message.error('请等待上传图片成功后在提交表单')
          return
        }
        // 处理选中的员工照片
